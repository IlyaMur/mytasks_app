...
При желании изменить параметры подключения к БД в файле `.env` и файле миграций `database/import.php`
...
Собрать и запустить приложение
    ...
    $ make docker-start # собрать проект и залить в него дамп базы  
    $ make docker-bash  # запустить сессию bash в docker-контейнере  
    $ make docker-test  # запустить тесты в docker-контейнере 
